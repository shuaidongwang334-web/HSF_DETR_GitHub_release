...
if __name__ == '__main__':
    ...
    if device.type == 'cuda':
        ...
        print(f'Peak allocated GPU memory: {peak_allocated:.2f} MB')
        print(f'Peak reserved GPU memory: {peak_reserved:.2f} MB')
        print('For the paper, report Peak allocated GPU memory because reserved memory includes PyTorch cache.')
